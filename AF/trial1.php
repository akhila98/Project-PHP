...
<div class="carousel-caption" style="margin-left:20px;" >
			...
			<h4 style="margin-left:60px;font-family: 'Dancing Script';"><b>Death brings pain that time can only heal.<br />
						...
						<br>
						<input type="button" value="Register For Services" class="btn site-btn1 px-4 py-3 mr-4 btn-light">
            </div>
					...
					<br><br>  
					   ...
					   <h1 style=" font-family: 'Pacifico' ; margin-left:500px;"><b>Contact Us</b><h1>
					  
					   <p style="font-size:20px ;font-family: 'Pacifico' ;margin-left:20%"><br/>
					   Please contact us about any of our services or to meet with one of our funeral service professionals. <br/>
					   You may contact our general office at (91) 9865765677. <br/>
					   For a detailed list of our locations click here or send us an email using our contact form below.
					</body>
					<br><br>
					<h1 style=" font-family: 'Pacifico' ; margin-left:500px;"><b>AfterLife, Inc</b></h1>
					<br><br>
					<h3 style=" font-family: 'Pacifico' ; margin-left:600px;"><b>Address</b>
					</h3>
					<br>
					<p style=" font-family: 'Pacifico' ; margin-left:500px;font-size:20px">Mahavir palace,C-1001,Dadar West,Mumbai-80</p>
					<br>
					<h3 style=" font-family: 'Pacifico' ; margin-left:600px;"><b>Telephone</b></h3><br/>
						<p style=" font-family: 'Pacifico' ; margin-left:500px;font-size:20px">(91) 9865765677.<br/>(91) 9865766677.</p>
						<br>
						<h1 style=" font-family: 'Pacifico' ; margin-left:500px;"><b>Follow Us</b></h1>
						<br>
						<img src="follow.jpg" width="90%" height="70%"style="margin-left:10%;" ></img>
					<br>
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <form class="form-signin" method="post">
              <div class="form-label-group">
                <input type="number" name="phone" class="form-control" id="phone" placeholder="Mobile Number" required autofocus>
                <label for="inputEmail">Mobile Number</label>
              </div>
				<button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" name="sendotp" id="sendotp">Send OTP</button>
				<br>
				<div class="form-label-group">
                <input type="number" name="otpn" class="form-control" id="otpn" placeholder="Enter OTP required autofocus">
                <label for="inputEmail">Enter OTP</label>
              </div>
			  <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button"  id="verify">Verify OTP</button>
...
$(document).ready( function() {
    ...
    {  
       ...
       .done(function(data){
        window.confirm("OTP send successfully");
       });
    });
   } );
           ...
           <form id="form" method="post" enctype="multipart/form-data">
			...
			<div class="form-label-group">
			  ...
			  <div class="form-label-group">
				...
				<div class="form-label-group">
                 <textarea type="text" id="officeaddress" name="officeaddress" class="md-textarea form-control" rows="3"  ></textarea>
                ...
                <label for="dob"  style="font-size:15px;color:black;">Date of Birth</label>
				<span id="statusDOB" class="statusDOB"></span>
              </div>
		 <label for="dob"  style="font-size:15px;color:black;"><b>Select Services</b></label><br/>
				<input type="checkbox" class="chkl" name="chkl[ ]" value="Catering">Catering Service<br />  
				<input type="checkbox" class="chkl" name="chkl[ ]" value="Ambulance">Ambulance Service<br />  
				<input type="checkbox" class="chkl" name="chkl[ ]" value="Doctor">Doctor<br />  
				<input type="checkbox" class="chkl" name="chkl[ ]" value="FreezerBox">FreezerBox Service<br />  
				<input type="checkbox" class="chkl" name="chkl[ ]" value="Prayer meet">Prayer meet Service<br />  
					<br>  
 
			
					<div class="form-label-group">
                <input type="phonenumber" name="gstno" id="gstno" class="form-control" placeholder="GST number"  required />
                <label for="inputEmail" style="font-size:15px;color:black;">GST number</label>
				<span id="message" class="message"></span>
              </div>
			
				<div class="form-label-group">
                <input type="phonenumber" name="licenseno" id="licenseno" class="form-control"   required />
              ...
              <div class="custom-control custom-checkbox mb-3">
                <input type="checkbox" value="Accept All Terms and condition" name="checkbox" >Accept All Terms and condition</input>
                
				
              </div>
			   
              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="Submit" id="Submit" value="Submit" onclick="saveData()">Register</button>
...
function saveData(){
	...
	var licenseno=$('#licenseno').val();
		...
		$.ajax({
			url:"insert.php",
			method:"POST",
			data:{name:name,email:email,phone:phone,homeaddress:homeaddress,officeaddress:officeaddress,dob:dob,gstno:gstno,licenseno:licenseno,occupation:occupation},
			success:function(data){
				window.confirm("Registered Succesfully!!Now login");
			}
		});
