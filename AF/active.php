...
if($res){
    ...
    window.alert('Event is Done!!')    </SCRIPT>");
}
else{
	echo ("<SCRIPT LANGUAGE='JavaScript'>
                    ...
                    <div class="col-sm-6">
                        <div class="btn-group" data-toggle="buttons">
                            ...
                            <label class="btn btn-warning active">
                             <a href="active.php" target="_parent" style="color:White">   <input type="radio" name="status" value="active" checked="checked"> Active</a>
                            </label>
...
$i=1;
$query="Select t1.service,t1.date,t1.status,t1.location,t2.fname,t1.r_id ,t2.email from order1 t1 join regi t2 on t1.r_id=t2.regiid where status='Approved' ";
$res=mysqli_query($db,$query);
