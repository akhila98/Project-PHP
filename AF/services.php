...
if(isset($_POST['accept']))
{
	...
	$query="Update orders set status='$status' ,comment='$comment' where c_id='$id'";
...
$i=1;
$query="Select t1.Demisedname ,t2.fname,t2.contact from users t1 join regi t2 on t1.c_id=t2.user_id where status='Pending' ";
$res=mysqli_query($db,$query);
...
if($count>0)
{
	while($row=mysqli_fetch_array($res))
	{
		?>
                        ...
                        <td><a href="#"><?php echo $row['services'];?></a></td>
