        ...
        <div class="card card-signin my-5">
          ...
          <span aria-hidden="true">&times;</span>
              ...
              <div class="form-label-group">
				...
				<button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" name="sendotp" id="sendotp" style="font-size: 80%;
  border-radius: 5rem;
  letter-spacing: .1rem;
  font-weight: bold;
  padding: 1rem;
  transition: all 0.2s;">Send OTP</button>
				<br>
				<div class="form-label-group">
			  ...
			  <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button"  id="verify" style="font-size: 80%;
  border-radius: 5rem;
  letter-spacing: .1rem;
  font-weight: bold;
  padding: 1rem;
  transition: all 0.2s;">Verify OTP</button>
...
$(document).ready( function() {
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="row">
        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center"  style="font-size:40px ;font-family: 'Pacifico' ;"><b>Register</b>
			...
			<div class="form-label-group">
			  ...
			  <div class="form-label-group">
			   <label for="inputaddress"><b>Home Address</b></label><br/>
				...
				<div class="form-label-group">
				<label for="inputaddress"><b>Office Address</b></label><br/>
