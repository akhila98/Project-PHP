 ...
 <nav class="navbar navbar-expand-md navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav" style="margin-left:250px;font-family: 'PAcifico';font-size:26px; ">
            <a href="demisedregi.php" class="nav-item nav-link active">Home</a>
                    ...
                    <div class="col-sm-6">
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-danger active">
								 <a href="corders.php" target="self" style="color:white">  <input type="radio" name="status" value="all" checked="checked">Pending</a>
                            </label>
                            <label class="btn btn-warning">
                             <a href="cactive.php" target="self" style="color:White">   <input type="radio" name="status" value="active"> Active</a>
                            </label>
                            
                            <label class="btn btn-success">
                              <a href="cexpired.php" target="self" style="color:Yellow">  <input type="radio" name="status" value="expired"> Expired</a>
                            </label>							
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th>Name of Registred person</th>
...
$i=1;
$query="Select t1.service,t1.date,t1.status,t1.location,t2.fname ,t2.email from order1 t1 join regi t2 on t1.r_id=t2.regiid where status='Pending' && regiid='$id' ";
